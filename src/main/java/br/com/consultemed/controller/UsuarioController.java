...
public class UsuarioController extends HttpServlet {
	...
	private void ativar_desativar(HttpServletRequest request, HttpServletResponse response) throws NumberFormatException, Exception {
		Usuario usuario = this.business.ativarDesativar(Long.parseLong(request.getParameter(Constantes.ID_USUARIO)));
	...
	private void delete(HttpServletRequest request, HttpServletResponse response) throws NumberFormatException, Exception {
		this.business.deleteById(Long.parseLong(request.getParameter(Constantes.ID_USUARIO)));
	...
	private void editar(HttpServletRequest request, HttpServletResponse response) throws NumberFormatException, Exception {
		...
		Usuario usuario = this.business.findById(Long.parseLong(request.getParameter(Constantes.ID_USUARIO)));
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException {
		...
		String nome = request.getParameter(Constantes.NOME_USUARIO);
		String login = request.getParameter(Constantes.LOGIN_USUARIO);
		String senha = request.getParameter(Constantes.SENHA_USUARIO);
		
		String telefone = request.getParameter(Constantes.TELEFONE_USUARIO);
		String email = request.getParameter(Constantes.EMAIL_USUARIO);
		String id = request.getParameter(Constantes.ID_USUARIO);
		boolean isAtivo = Boolean.parseBoolean(request.getParameter(Constantes.ATIVO_USUARIO)); 
		String [] permissoes = request.getParameterValues(Constantes.PERMISSOES_USUARIO);
		...
		if(id != "") {
			...
			request.setAttribute(Constantes.EDITAR_ENTIDADE, nome + " " +Constantes.USUARIO_EDITADO);
		}else {
			request.setAttribute(Constantes.CADASTRAR_ENTIDADE, nome + " " + Constantes.USUARIO_SUCESSO);			
		}
