...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Contato contato = new Contato();
		// contato.setId(null);	//tanto faz colocar esta linha, pois será gerenciado pelo SGBD.
		// contato.setNome("Herbson Silva");
		// contato.setEmail("herbsonsilvajp@gmail.com");
		// contato.setTelefone("83988416644");
		...
		// // 	System.out.println("Contato: '" + contato.getNome() + "' localizado com sucesso!");
		// // } catch (Exception e) {
		...
		// System.out.println("Contato " + contatoBanco.getNome() + " retornado com sucesso.");
	}
}
